...
DDModeling uses a combination of grid-search and downhill simplex in order to fit a given model. Therefore there is a need to calculate a grid before fitting. This can be done with the _Generate_GRID_ function:
```{r eval=FALSE}
